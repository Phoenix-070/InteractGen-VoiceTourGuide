...
const SignIn: React.FC<SignInProps> = ({ onSwitch }) => {
    ...
    return (
        ...
        >
            ...
            <h2 style={{ marginBottom: '8px', fontSize: '18px', fontWeight: '600', color: '#374151' }}>Welcome Back</h2>
            <p style={{ marginBottom: '24px', fontSize: '13px', color: '#6B7280' }}>Sign in to continue your tour</p>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <motion.button
                    ...
                    disabled={isLoading}
                    style={{
                        padding: '12px', background: 'linear-gradient(135deg, #3B82F6 0%, #2563EB 100%)',
            ...
            <div style={{ marginTop: '24px', fontSize: '13px', color: '#6B7280' }}>
                New here? <motion.span whileHover={{ scale: 1.05 }} onClick={onSwitch} style={{ color: '#3B82F6', cursor: 'pointer', fontWeight: '600', display: 'inline-block' }}>Create an account</motion.span>
            </div>
        </motion.div>
    );
};
